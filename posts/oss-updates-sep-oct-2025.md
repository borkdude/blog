...
- I'm pretty excited by [Eucalypt](https://github.com/chr15m/eucalypt), a remake
  ...
  [Squint](https://github.com/squint-cljs/squint) without React. It lets you build UIs with
  the Reagent API in less than 10kb of gzip'ed JS. The code was initially
  generated by an LLM, but now work is going into making the code base thoroughly
  tested and simplified where possible.
